...
class GarnetEhullPredTest(unittest.TestCase):
    def setUp(self):
        ...
        self.amix_species = {
            'a': {get_el_sp('Ga3+'): 0.5, get_el_sp('In3+'): 0.5},
            'c': {get_el_sp('Sm3+'): 1},
            'd': {get_el_sp('Ga3+'): 1}}
        self.amix_des = [
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 0, 1,
             1],
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 1, 0,
             0],
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 0, 0,
             1],
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 0, 0,
             0],
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 0, 1,
            ...
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 1, 0,
             1],
            [0.76, 1.81, 0.94, 1.78, 1.0979999999999999, 1.17, 0.76, 1.81, 1, 1,
             0]]
        self.amix_des.sort()
        ...
        self.cmix_species = {"a": {get_el_sp("Sc3+"): 1},
                             ...
                             "d": {get_el_sp("Si4+"): 1}}
        self.cmix_des = [
            [0.86, 1.31, 0.88, 1.65, 0.885, 1.36, 0.54, 1.9, 0, 0, 0, 0, 0],
        ...
        self.dmix_des = [
            [0.83, 1.96, 0.54, 1.9, 1.32, 0.95, 0.675, 1.61, 0, 0, 1, 0, 0],
    ...
    def test_cmix(self):
        ...
        self.assertAlmostEqual(tot_e, self.cmix_dft_tote + (
        form_e - self.cmix_dft_form_e))
    ...
    def test_dmix(self):
        ...
        self.assertAlmostEqual(tot_e, self.dmix_dft_tote + (
        form_e - self.dmix_dft_form_e))
